...
export function AuthProvider({ children }) {
  ...
  useEffect(() => {
    ...
    // Sugerencia 2: Coordinación en tiempo real por Storage Event Listener
    const handleStorageChange = (e) => {
      try {
        ...
        if (e.key === `yoy_ia_session_${currentSalonId}`) {
          console.log("[Storage Coordinator] Cambio en sesion del salon detectado, sincronizando pestaña...");
